    ...
    <div class="contact-inner-container">
      <div class="contact-info-container">
        ...
        <div class="contact-details">
          ...
          <p>ESEN, Manouba, Tunis, 1080.</p>
        </div>
        <hr />

        <div class="contact-details">
          <h3><i class="fa fa-envelope"></i> Email</h3>
          <a href="mailto:aa.travel.com" class="contact-link">HackathonHub@HackathonHub.com</a>
        </div>
        <hr />
      ...
      <div class="location container">
        <iframe src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=tunisia esen&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="600" height="550" style="border: 0" allowfullscreen="" loading="lazy"></iframe>
      </div>
    </div>
  </div>
</section>