 ...
 <div id="carouselExampleCaptions" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="IMAGES/hack1.jpg" class="d-block w-100 opacity-50" alt="...">
    ...
    <div class="carousel-item">
      <img src="IMAGES/hack2.jpg" class="d-block w-100 opacity-50" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Code Hunters</h5>
    ...
    <div class="carousel-item">
      <img src="IMAGES/hack3.jpg" class="d-block w-100 opacity-50" alt="...">
      <div class="carousel-caption d-none d-md-block">
